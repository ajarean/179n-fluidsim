...
public class SPH : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        shader.Dispatch(densityPressureKernel, groups, 1, 1); // 1. Compute Density/Pressure
        shader.Dispatch(computeForceKernel, groups, 1, 1);    // 2. Compute Forces
        shader.Dispatch(integrateKernel, groups, 1, 1);       // 3. Integrate
    }
